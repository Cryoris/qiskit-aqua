...
class TwoLocalCircuit(NLocalCircuit):
    """The two-local gate circuit.
    ...
    def __init__(self,
        ...
        Examples:
            >>> ansatz = TwoLocalCircuit(3, 'ry', 'cx', 'linear', reps=2, insert_barriers=True)
            ...
            >>> ansatz = TwoLocalCircuit(3, ['ry','rz'], 'cz', 'full', reps=1, insert_barriers=True)
            ...
            >>> ansatz = TwoLocalCircuit(3, 'x', 'crx', entangler_map, reps=1)
            ...
            >>> ansatz = TwoLocalCircuit(4, [], 'cry', entangler_map, reps=1)
    ...
    def blocks(self) -> List[Instruction]:
        ...
        self._param_count = 0
        self._base_params = []
        # define the blocks of this NLocalCircuit
    ...
    @NLocalCircuit.base_parameters.getter
    ...
    @NLocalCircuit.num_qubits.setter
    def num_qubits(self, num_qubits: int) -> None:
        ...
        Note:
            Additionally to invalidating the circuit (which is done in NLocalCircuit.num_qubits),
    ...
    @property
    def depth(self) -> int:
        """Return the depth of the two-local NLocalCircuit.
        ...
        Example:
            >>> ansatz = TwoLocalCircuit(2, 2, 'ry', 'cx')  # the second argument, depth, is 2
            >>> ansatz
                    ┌────────┐     ┌────────┐     ┌────────┐
    ...
    def entanglement_gates(self) -> List[Tuple[type, int]]:
        ...
        """
        gate_param_list = [TwoLocalCircuit.identify_gate(gate) for gate in self._entanglement_gates]
    ...
    def rotation_gates(self) -> List[Tuple[type, int]]:
        ...
        """
        gate_param_list = [TwoLocalCircuit.identify_gate(gate) for gate in self._rotation_gates]
        return gate_param_list
