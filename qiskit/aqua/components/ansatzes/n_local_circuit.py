...
class NLocalCircuit(QuantumCircuit):
    ...
    def to_gate(self) -> Gate:
        ...
        If the NLocalCircuit contains only unitary operations(i.e. neither measurements nor barriers)
        return this NLocalCircuit as a Gate.
        ...
        try:
            ...
            raise AquaError('The NLocalCircuit contains non-unitary operations (e.g. barriers, resets or '
